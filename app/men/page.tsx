...
const CATEGORY_SECTIONS = [
  {
    ...
    badge: "Just In",
    count: 24,
    description: "Fresh designs this week"
  },
  {
    id: "best-sellers",
    title: "Best Sellers",
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="pt-20">
                {/* Hero Banner */}
                <section className="relative h-[300px] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 h-full flex flex-col justify-center relative z-10">
                        ...
                        <p className="text-xl text-gray-300 max-w-2xl">
                            Built for the everyday rebel. Discover premium styles designed for comfort and confidence.
                        </p>
                    </div>
                </section>
